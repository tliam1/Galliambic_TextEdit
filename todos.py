# TODO (Functionality): create a better saving system that has support for importing into other text docs (dump file doesnt translate)
...
# TODO (BUG): If there are no words currently on the text doc, you can't change the font

# TODO (Functionality): word coloring based on function, variable, etc
    # in progress
